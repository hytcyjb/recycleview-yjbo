package com.yy.yjbo.recycleview_yjbo.test;
 ...
 */
public class DividerGridItemDecorationCopy1 extends RecyclerView.ItemDecoration
{
    ...
    public DividerGridItemDecorationCopy1(Context context, int mheadCount, int mfootCount)
    {
